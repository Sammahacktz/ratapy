"""PiNeoPixel -- an addressable WS2812/WS2811 LED strip on the master.
...
PWM/PCM/SPI DMA. So a PiNeoPixel strip plugs into the Pi and is a `LocalDevice`::
...
class PiNeoPixel(LocalDevice):
    ...
    def __repr__(self) -> str:
        return f"PiNeoPixel(count={self.count}, pin={self.pin})"
